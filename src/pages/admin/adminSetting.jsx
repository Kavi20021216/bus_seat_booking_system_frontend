...
export default function SettingsAdminPage() {
  ...
  return (
    <div className="w-full min-h-screen flex justify-center items-center bg-gray-50 text-gray-800">
      <div className="w-125 bg-white border-gray-200 rounded-2xl shadow-2xl p-10 flex flex-col items-center">
        
        {admin.image ? (
          <img
            src={admin.image}
            alt="Admin"
            className="w-30 h-30 rounded-full object-cover border-4 border-gray-800 shadow-lg"
          />
        ) : (
          <FaUserCircle className="text-[120px] text-red-400 mb-2" />
        )}
        ...
        <p className="text-gray-500">{admin.role || "Admin"}</p>
